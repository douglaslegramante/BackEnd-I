...
var tamanho_colecao = curiosidades_chuck_norris.length; //Obtem o tamanho do array

var numero_sorteado = Math.floor(Math.random() * tamanho_colecao); //Retorna um inteiro entre entre 0 e 9
